/// @description  menu_fn_open_menu(menu_root_items_script, draw_ignores_views = false, is_touchscreen = false)
/// @param menu_root_items_script
/// @param  draw_ignores_views = false
/// @param  is_touchscreen = false
