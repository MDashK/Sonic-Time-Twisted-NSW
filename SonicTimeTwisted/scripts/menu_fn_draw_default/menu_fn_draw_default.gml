                ...
                if(array_length_2d(items, actual_index) == 4)
                {
                    ...
                    if(items[actual_index, 2])
                    {
                        ...
                        draw_text(internal__draw_menu_buttons_offset_x + 18,
                            ...
                            string_hash_to_newline(items[actual_index, 0]));
                        draw_set_halign(fa_right);
                        draw_text(internal__draw_menu_buttons_offset_x + button_width - 8,
                            internal__draw_menu_buttons_offset_y + button_slot_height * visible_index + 8 + text_y_offset,
                            string_hash_to_newline(items[actual_index, 3]));
                    }
                    else
                    {
        ...
        switch(state)
        {
            ...
            case 21:
                ...
                if(state == 10)
                {
                    ...
                    draw_set_font(objResources.fontHudMin);
                    draw_set_colour(c_white);
                    draw_text(internal__draw_menu_rect_x_center, internal__draw_confirmation_rect_y1 + margin, string_hash_to_newline(confirmation_text));
                    ...
                    draw_text(
                        ...
                        internal__draw_confirmation_buttons_y + 3 + text_offset, string_hash_to_newline(confirmation_yes_label)
                    );
                    ...
                    draw_text(
                        ...
                        internal__draw_confirmation_buttons_y + 3 + text_offset, string_hash_to_newline(confirmation_no_label)
                    );
                    draw_set_colour(c_white);
                }
                else
                {
                    if(state == 13 || state == 14 || state == 20 || state == 21)
                    {
                        ...
                        draw_set_font(objResources.fontHudMin);
                        draw_set_colour(c_white);
                        draw_text(internal__draw_confirmation_rect_x_center, internal__draw_confirmation_rect_y1 + margin, string_hash_to_newline(confirmation_text));
                    }
                    else
                    {
                        if(state == 17)
                        {
                            ...
                            draw_text(internal__draw_confirmation_rect_x_center, internal__draw_confirmation_rect_y2 - margin, string_hash_to_newline(string(confirmation_cursor)));
                            draw_set_valign(fa_middle);
                            draw_set_halign(fa_left);
                            draw_text(internal__draw_confirmation_rect_x1 + margin, internal__draw_menu_rect_y_center, string_hash_to_newline(string(confirmation_no_action)));
                            draw_set_halign(fa_right);
                            draw_text(internal__draw_confirmation_rect_x2 - margin, internal__draw_menu_rect_y_center, string_hash_to_newline(string(confirmation_yes_action)));
                            draw_set_halign(fa_center);
                            draw_set_valign(fa_top);   
