...
if(mouse_check_button_pressed(mb_left))
{
    mouse_prev_x = mouse_x - __view_get( e__VW.XView, 0 );
    mouse_prev_y = mouse_y - __view_get( e__VW.YView, 0 );
    mouse_dx = 0;
    mouse_dy = 0;
    mouse_click_registered = false;
    x_on_press = mouse_x + __view_get( e__VW.XView, 0 );
    y_on_press = mouse_y;
    
}
if(mouse_check_button(mb_left))
{
    mouse_dx = mouse_x - __view_get( e__VW.XView, 0 ) - mouse_prev_x;
    mouse_dy = mouse_y - __view_get( e__VW.YView, 0 ) - mouse_prev_y;
    mouse_prev_x = mouse_x - __view_get( e__VW.XView, 0 );
    mouse_prev_y = mouse_y - __view_get( e__VW.YView, 0 );
}
...
if(mouse_check_button_released(mb_left))
{
    switch(selectState)
    {
        ...
        case 5:
            ...
            if(abs(mouse_x + __view_get( e__VW.XView, 0 ) - x_on_press) <= 2)
            {
                tap_registered = true;
            }
